...
- **Passo 7 — estensione/rifinitura (in corso)**: rendere ESPN parzialmente tollerante al 403, assicurare un percorso storico/predittivo per NED1/POR1 senza inventare dati, report pre/post in italiano e rifinitura di Accuratezza dopo le prime gare previste. Procedere per piccoli passi verificati.
